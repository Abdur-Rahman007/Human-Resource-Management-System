<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="JobFinder.Admin.NewJob" %>
        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3"> 
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex.  MCA, MBA" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight:600">Experience Required</label>
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex: 2 Years" required>
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3"> 
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: 25000/Month" required>                        
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Enter Work Address" 
                        TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#000000" Text="Add Job"
