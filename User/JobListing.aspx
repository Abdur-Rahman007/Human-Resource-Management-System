<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="JobFinder.User.JobListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        .scrollable-job-list {
        max-height: 900px; /* İş ilanlarının kaplayacağı maksimum yükseklik */
        overflow-y: auto; /* Dikeyde scroll bar ekler */
        }            
    </style>

<!-- scrollable-job-list = jobların alt alta sıralanıp yandan kaydrırlabilmesi için eklendi-16 eylül 2024 -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4">
                        ...
                        <div class="job-category-listing mb-50 ">
                            <!-- job-category-listing mb-50 pb-0 -->
                            <!-- single one -->
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    <asp:DropDownList ID="ddlCountry" runat="server" name="select" CssClass="form-control w-100"
                                     ...
                                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JobFinderConnectionString %>"
                                        SelectCommand="SELECT [CountryName] FROM [Country]" ProviderName="<%$ ConnectionStrings:JobFinderConnectionString.ProviderName %>"></asp:SqlDataSource>
                                </div>
