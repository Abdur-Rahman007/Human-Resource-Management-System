                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                            <asp:Button ID="btnPersonalInfo" runat="server" Text="Kişisel Bilgiler" CssClass="btn btn-primary btn-block"
                                                OnClick="btnPersonalInfo_Click" />
                                        </li>
                                        <li class="list-group-item">
                                            <asp:Button ID="btnIsIlan" runat="server" Text="İş İlanı Oluştur" CssClass="btn btn-primary btn-block"
